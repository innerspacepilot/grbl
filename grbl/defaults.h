...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_STEPS_PER_MM 159.844
  #define DEFAULT_Y_STEPS_PER_MM 159.844
  #define DEFAULT_Z_STEPS_PER_MM 100.0
  #define DEFAULT_X_MAX_RATE 170.0 // mm/min
  #define DEFAULT_Y_MAX_RATE 170.0 // mm/min
  ...
  #define DEFAULT_Y_MAX_TRAVEL 215.0 // mm NOTE: Must be a positive value.
  ...
  #define DEFAULT_HOMING_PULLOFF 0.2 // mm
#endif
